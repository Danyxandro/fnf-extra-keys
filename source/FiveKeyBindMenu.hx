...
class FiveKeyBindMenu extends FlxSubState
{
    ...
    var keys:Array<String> = [FlxG.save.data.F0Bind,
                              FlxG.save.data.F1Bind,
                              FlxG.save.data.F2Bind,
                              FlxG.save.data.F3Bind,
                              FlxG.save.data.F4Bind];
    ...
    function save(){
        ...
        FlxG.save.data.F0Bind = keys[0];
        FlxG.save.data.F1Bind = keys[1];
        FlxG.save.data.F2Bind = keys[2];
        FlxG.save.data.F3Bind = keys[3];
        FlxG.save.data.F4Bind = keys[4];
