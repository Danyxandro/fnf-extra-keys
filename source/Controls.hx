...
class Controls extends FlxActionSet
{
	...
	public var F0(get, never):Bool;
	public var F1(get, never):Bool;
	public var F2(get, never):Bool;
	public var F3(get, never):Bool;
	public var F4(get, never):Bool;

	public var F0_P(get, never):Bool;
	public var F1_P(get, never):Bool;
	public var F2_P(get, never):Bool;
	public var F3_P(get, never):Bool;
	public var F4_P(get, never):Bool;

	public var F0_R(get, never):Bool;
	public var F1_R(get, never):Bool;
	public var F2_R(get, never):Bool;
	public var F3_R(get, never):Bool;
	public var F4_R(get, never):Bool;
	...
	inline function get_F0() return _f0.check();
	inline function get_F1() return _f1.check();
	inline function get_F2() return _f2.check();
	inline function get_F3() return _f3.check();
	inline function get_F4() return _f4.check();
	inline function get_F0_P() return _f0P.check();
	inline function get_F1_P() return _f1P.check();
	inline function get_F2_P() return _f2P.check();
	inline function get_F3_P() return _f3P.check();
	inline function get_F4_P() return _f4P.check();
	inline function get_F0_R() return _f0R.check();
	inline function get_F1_R() return _f1R.check();
	inline function get_F2_R() return _f2R.check();
	inline function get_F3_R() return _f3R.check();
	inline function get_F4_R() return _f4R.check();
	...
	public function loadKeyBinds()
	{
		...
		inline bindKeys(Control.F0, [FlxKey.fromString(FlxG.save.data.F0Bind)]);
		inline bindKeys(Control.F1, [FlxKey.fromString(FlxG.save.data.F1Bind)]);
		inline bindKeys(Control.F2, [FlxKey.fromString(FlxG.save.data.F2Bind)]);
		inline bindKeys(Control.F3, [FlxKey.fromString(FlxG.save.data.F3Bind)]);
		inline bindKeys(Control.F4, [FlxKey.fromString(FlxG.save.data.F4Bind)]);
	}
